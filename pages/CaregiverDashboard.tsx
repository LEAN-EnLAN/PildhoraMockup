...
export type View = 'home' | 'history' | 'meds' | 'tasks' | 'device';
...
const CaregiverDashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-100 font-sans">
            <header className="bg-slate-100 sticky top-0 z-20 p-4 border-b border-slate-200">
                <div className="max-w-4xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button 
                            ...
                            className="px-4 py-2 text-sm font-semibold text-white bg-pildhora-primary rounded-lg hover:bg-green-700 active:scale-95 transition-transform"
                        >
                            Salir
                        </button>
                    </div>
            ...
            <main className="p-4 sm:p-6 max-w-4xl mx-auto pb-28">
                {renderContent()}
            </main>
